...
const tracks: Track[] = [
  { title: "Neon Drift", src: "/demo/neon-drift.wav", gradient: "linear-gradient(135deg,#E23A34,#8b1e1a)" },
  { title: "Afterglow", src: "/demo/afterglow.wav", gradient: "linear-gradient(135deg,#415A77,#17161A)" },
  { title: "Static Bloom", src: "/demo/static-bloom.wav", gradient: "linear-gradient(135deg,#8A5A16,#3a2606)" },
  { title: "Low Orbit", src: "/demo/low-orbit.wav", gradient: "linear-gradient(135deg,#1F9D6B,#0d3d2a)" },
  { title: "Midnight Run", src: "/demo/midnight-run.wav", gradient: "linear-gradient(135deg,#6E4AA6,#241640)" },
  { title: "Phantom", src: "/demo/phantom.wav", gradient: "linear-gradient(135deg,#4e6a8a,#17161A)" },
];
...
export default function DemoSection() {
  ...
  const visible = tracks.slice(page * PAGE_SIZE, page * PAGE_SIZE + PAGE_SIZE);

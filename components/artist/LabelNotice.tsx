...
export default function LabelNotice() {
  return (
    <div className="flex items-start gap-[10px] rounded-[12px] border-[0.5px] border-[#D2D0CB] bg-[#F0EEEA] px-[14px] py-[11px] mb-4">
      <AlertTriangle
        className="w-[14px] h-[14px] text-[#17161A] shrink-0 mt-[2px]"
        strokeWidth={2.25}
      />
      <p className="text-[12px] leading-[1.45] text-[#6E6D73]">
        <span className="font-semibold text-[#17161A]">Важно.</span> Все треки

...
const faqs: FaqItem[] = [
  ...
  {
    q: "Новости и мероприятия — что это?",
    a: "Это анонсы мероприятий и новости от лейбла: концерты, шоукейсы, показы и важные напоминания. Хотите попасть на событие — нажмите «Хочу пойти»: запрос уйдёт менеджеру, а вы увидите подтверждение «Запрос отправлен».",
  },
];

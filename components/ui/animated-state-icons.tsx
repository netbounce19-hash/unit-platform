...
/* ─── Controlled version of SuccessIcon (no auto-toggle) ─── */
export function SuccessIconControlled({
  size = 40,
  color = "currentColor",
  className,
  done = false,
}: Omit<StateIconProps, "duration"> & { done: boolean }) {
  return (
    <svg
      viewBox="0 0 40 40"
      fill="none"
...
/* ─── Controlled LockUnlockIcon ─── */
export function LockUnlockIconControlled({
  size = 40,
  color = "currentColor",
  className,
  unlocked = false,
}: Omit<StateIconProps, "duration"> & { unlocked: boolean }) {
  return (
    <svg
      viewBox="0 0 40 40"
      fill="none"
...
/* ─── Controlled NotificationIcon ─── */
export function NotificationIconControlled({
  size = 40,
  color = "currentColor",
  className,
  hasNotif = false,
}: Omit<StateIconProps, "duration"> & { hasNotif: boolean }) {
  return (
    <motion.svg
      viewBox="0 0 40 40"
      fill="none"
...
/* ─── Controlled DownloadDoneIcon ─── */
export function DownloadDoneIconControlled({
  size = 40,
  color = "currentColor",
  className,
  done = false,
...
/* ─── Controlled SendIcon ─── */
export function SendIconControlled({
  size = 40,
  color = "currentColor",
  className,
  sent = false,
}: Omit<StateIconProps, "duration"> & { sent: boolean }) {
  return (
    <svg
      viewBox="0 0 40 40"
      fill="none"

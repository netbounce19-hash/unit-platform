...
const FAQ: { q: string; a: string }[] = [
  ...
  },
  {
    ...
    a: "Выполнение задач считается автоматически — по закрытым задачам. Стримы и слушателей пока вносит менеджер в разделе «Загрузка данных»: подключение к площадкам ещё впереди.",
  },
  {
